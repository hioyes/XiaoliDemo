...
public class PuzzleView extends View {
    ...
    public PuzzleView(Context context, AttributeSet attrs) {
        ...
        mBitmap = ((BitmapDrawable) ContextCompat.getDrawable(mContext,R.drawable.puzzle_default)).getBitmap();
//        mBitmap = ((BitmapDrawable)mResources.getDrawable(R.drawable.puzzle_default)).getBitmap();
    ...
    private void initSound(){
        ...
        s_move = soundPool.load(mContext, R.raw.s_move,1);
        s_error = soundPool.load(mContext,R.raw.s_error,1);
    }
